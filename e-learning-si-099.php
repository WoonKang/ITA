      ...
      <div>
        <ul>
          ...
          <li><a style="color:Black; font-size:15px; padding:20px; text-align:center; margin-top:0px;
            font-style:oblique;">e-learning</a></li>
        </ul>
      </div>
      <div class="display">
          <video width="800" height="250" controls muted autoplay>
             <source src="./data/Advantages and Disadvantages of e learning.mp4" type="video/mp4">
          </video>
      </div>
      <div class="display">
          <iframe src="./data/advantage-elearning" style="border-color: blue; background-color: gainsboro;
