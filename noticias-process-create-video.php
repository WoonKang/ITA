 <?php
 $file_title = $_POST['videotitle'];
 $target_dir = "./noticias/entertainment/";
 $target_name = "./noticias/entertainment/" .$file_title;
 $rand = rand(10000000, 999999999);
 $time = time();
 $file_name = $rand.$time.$_FILES["fileToUpload"]["name"];
 $target_file = $target_name . '.mp4';
